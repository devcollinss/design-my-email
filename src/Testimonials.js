...
export default ({
  ...
  testimonials = [
    {
      customerName: "Collins Ikechukwu",
      customerProfile: "CEO, K-Logistics",
      imageSrc:
      ...
      quote:
        "I've been using this MailHub for months now, and I can confidently say that it has revolutionized my email marketing strategy. The customizable templates and advanced features have helped me create personalized and engaging emails that have resulted in higher open rates and conversions. Highly recommend!",
    },
    {
      customerName: "Henry Ezeanyim",
      customerProfile: "Founder, Oracus Digital Agency",
      imageSrc:
      ...
      quote:
        "I was hesitant to try yet another email platform, but I'm so glad I did. The user-friendly interface and variety of design options made it easy for me to create emails that aligned with my brand. Plus, the customer support team was responsive and helpful whenever I had questions. Thank you!",
    },
    {
      customerName: "Ukpaa Chigozie",
      customerProfile: "Freelance Texhnical Writer, ZegoCLoud",
      imageSrc:
      ...
      quote:
        "As a small business owner, I don't have the time or resources to create complex email campaigns. This product has made it possible for me to create professional-looking emails with just a few clicks. The pre-made templates and drag-and-drop design tools are a game-changer. Thank you for making email marketing accessible to all!",
    },
  ],
}) => {
