...
export default ({
  subheading = "Pricing",
  heading = "Our Flexible Plans",
  description = "Choose the Perfect Plan for Your Email Needs",
  plans = null,
  ...
  const defaultPlans = [
    {
      name: "Free Plan",
      durationPrices: ["$0", "$0"],
      mainFeature: "For Small Business",
      features: [
        "Access to limited templates",
        "Basic email editor with customizable templates",
        "Limited image scaling options",
        "Basic font selection and formatting options",
        "Basic color palette selection",
        "Limited integration options",
        "Email delivery analytics with basic reporting features.",
      ],
    },
    {
      name: "Pro Plan",
      durationPrices: ["$30", "$330"],
      mainFeature: "Suited for Big Business",
      features: [
        "Unlimited access to all email templates and design elements",
        "Advanced analytics and reporting tools",
        "A/B testing capabilities for optimizing email campaigns",
        "Integration with popular CRM and marketing automation platforms",
        "Customizable email workflows and automation sequences",
        "Priority customer support and personalized training sessions.",
      ],
      featured: true,
    },
  ];
